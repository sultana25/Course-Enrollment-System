...
class StudentProfile extends Db
{
    ...
    {
        $query = "INSERT INTO `student_master` (`name`, `email`, `phnnumber`, `image`) VALUES ( '" . $this->name . "', '" . $this->email . "', '" . $this->phnnumber . "', '" . $this->image_name . "')";
        $result = mysqli_query($this->conn, $query);
        if ($result) {
            Message::message("<div class=\"alert alert-success\">
  <strong>Success!</strong> Data has been stored successfully.
</div>");
            Utility::redirect("../views/student_panel.php");
